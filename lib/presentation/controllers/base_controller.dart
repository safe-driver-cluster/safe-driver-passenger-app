  ...
  Future<void> signUpWithEmailAndPassword({
    ...
    try {
      ...
      if (e.toString().contains('PigeonUserDetails') ||
        ...
        print(
            '🔧 PigeonUserDetails error detected, checking if user was created...');
        ...
        if (currentUser != null) {
          ...
          try {
            ...
            print(
                '🎉 Signup process completed successfully despite plugin error!');
            setData();
            return;
          } catch (profileError) {
            print('❌ Error creating passenger profile: $profileError');
            setError(
                'Account created but profile setup failed: ${profileError.toString()}');
            return;
          }
        }
      }
